...
export default function HowItWorks() {
  ...
  return (
    <div className={c.cont}>
      <div className={c.title}>Reduza custos <br/> Aumente os pedidos!</div>
      <div className={c.wrapper}>
        <Card 
          title='Pedidos Dinâmicos'
          description='Com menus acessíveis via QR Code, os clientes fazem pedidos direto do celular, eliminando etapas desnecessárias.'
